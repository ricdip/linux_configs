...
local nvim_tree = "nvim-tree"
local nvim_tree_api = "nvim-tree.api"

local helper = require("helpers")
if not helper.load(nvim_tree) then
    print("nvim-tree: reload required")
    return
end

if not helper.load(nvim_tree_api) then
    print("nvim-tree.api: reload required")
    return
end

local function on_attach(bufnr)
    local api = helper.load(nvim_tree_api)
...
local nvimtree = helper.load(nvim_tree)
nvimtree.setup {
    on_attach = on_attach,
