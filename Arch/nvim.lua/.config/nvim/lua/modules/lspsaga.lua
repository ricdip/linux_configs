...
local nlcl_opts = {desc = 'Show line diagnostics', helper.table_unpack(default_opts)}
local nlcd_opts = {desc = 'Show cursor diagnostics', helper.table_unpack(default_opts)}
local nlo_opts = {desc = 'Outline toggle', helper.table_unpack(default_opts)}
local nK_opts = {desc = 'Displays hover information', helper.table_unpack(default_opts)}
...
-- code action
helper.set_keymap({"n", "v"}, "<leader>ca", "<cmd>Lspsaga code_action<cr>", nlca_opts)
...
helper.set_keymap("n", "<leader>ld", "<cmd>Lspsaga show_line_diagnostics<cr>", nlcl_opts)

-- show cursor diagnostic
helper.set_keymap("n", "<leader>cd", "<cmd>Lspsaga show_cursor_diagnostics<cr>", nlcd_opts)

-- diagnostic jump can use `<c-o>` to jump back
helper.set_keymap("n", "[e", "<cmd>Lspsaga diagnostic_jump_prev<cr>", { silent = true })
helper.set_keymap("n", "]e", "<cmd>Lspsaga diagnostic_jump_next<cr>", { silent = true })
