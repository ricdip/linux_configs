...
helper.set_keymap("n", "<leader>xw",
                  "<cmd>TroubleToggle workspace_diagnostics<cr>", nlxw_opts)

-- document diagnostics from the builtin LSP client
helper.set_keymap("n", "<leader>xd",
                  "<cmd>TroubleToggle document_diagnostics<cr>", nlxd_opts)

-- items from the window's location list
helper.set_keymap("n", "<leader>xl", "<cmd>TroubleToggle loclist<cr>", nlxl_opts)

-- quickfix items
helper.set_keymap("n", "<leader>xq", "<cmd>TroubleToggle quickfix<cr>",
                  nlxq_opts)
...
helper.set_hl('TroubleTextError',
              {fg = helper.coding.lsp.diagnostics_colors.error})
helper.set_hl('TroubleTextWarning',
              {fg = helper.coding.lsp.diagnostics_colors.warn})
helper.set_hl('TroubleTextInformation',
              {fg = helper.coding.lsp.diagnostics_colors.info})
helper.set_hl('TroubleTextHint',
              {fg = helper.coding.lsp.diagnostics_colors.hint})
